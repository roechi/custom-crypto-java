...
public class PseudoPrimeEulerBatchTest {
    ...
    public void testNotPrimeFermat(TestData testData) throws Exception {
        ...
        if (decStringA.equals("NAN")) {
            result = pseudoPrime.isPrimeEuler(10);
        } else {
            BigInt baseOfFailure = new BigInt(decStringA);

            result = pseudoPrime.isPrimeEuler(new BigInt[]{baseOfFailure});
        }
    ...
    public static class TestData {
        ...
        public static List<TestData> testData() throws IOException {
            ...
            InputStream fis = new FileInputStream("src/test/resources/pseudo_prime_euler.txt");
