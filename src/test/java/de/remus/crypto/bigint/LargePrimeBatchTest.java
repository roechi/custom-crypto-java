...
public class LargePrimeBatchTest {
    ...
    public void testPrimeFermat(TestData testData) throws Exception {
        ...
        boolean result = number.isPrimeFermat(10);
    ...
    public void testPrimeEuler(TestData testData) throws Exception {
        ...
        boolean result = number.isPrimeEuler(10);
    ...
    public void testPrimeMillerRabin(TestData testData) throws Exception {
        ...
        boolean result = number.isPrimeMR(10);
    ...
    public static class TestData {
        ...
        public static List<TestData> testData() throws IOException {
            ...
            InputStream fis = new FileInputStream("src/test/resources/large_primes_tests.txt");
